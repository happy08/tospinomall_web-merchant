<template>
    ...
    <div class="p-25 mb-25 bg-white round-4">
        ...
        <el-radio-group v-model="radio">
            <el-radio-button label="0">近3个月</el-radio-button>
            <el-radio-button label="1">3个月前</el-radio-button>
        </el-radio-group>
    ...
    <div class="p-25 bg-white round-4">
        <div class="flex between vcenter table_header">
            <div class="flex vcenter">
                ...
                <div class="ml-15">
                    <el-checkbox-group v-model="checkboxGroup1" size="small" class="el-checkbox__inner_custom">
                        <el-checkbox label="退货协商中" border></el-checkbox>
                        <el-checkbox label="待出库" border></el-checkbox>
                        <el-checkbox label="退货出库完成" border></el-checkbox>
                    </el-checkbox-group>
                </div>
            </div>
            <div class="flex vcenter">
                <span>实用工具:</span>
                <div class="ml-15"><BmTableOption table="seller" :column="tableColumn" /></div>
                <el-button plain class="ml-15">导出Excel</el-button>
            </div>
        </div>
...
export default {
    ...
    setup(props) {
        ...
        //表格选项的列
        const tableColumn = [proxy.$t("data"), "姓名", "地址", "标签"];
